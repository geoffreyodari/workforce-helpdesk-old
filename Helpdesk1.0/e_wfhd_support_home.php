<?php require_once("e_wfhd/php/links.php"); ?>
<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        <li><a ><span class="sr-only">(current)</span>Home</a></li>
        <li ><a href="<?php echo $support_assigned_tickets; ?>">My Tickets</a></li>
		<li class="active"><a href="<?php echo $support_view_all_tickets; ?>">All Tickets</a></li>
		</ul>
    <!-- /.navbar-collapse -->
  </div><!-- /.container-fluid -->
</div>
...
<footer class="footer">
      <div class="container">
        <p class="text-muted">&copy; Odari <script> document.write(new Date().getFullYear());</script></p>
      </div>
    </footer>
